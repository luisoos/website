        ...
        <div class="music-status mb-2 py-2">
          <a :href="currentTrackUrl" target="_blank" rel="noreferrer">
            <div class="flex flex-row items-center">
              ...
              <p v-if="!(currentStatus === 'Not listening to anything!')" class="music text-left"> <span class="font-medium"> Currently playing: </span> <span class="opacity-80 font-semibold"> {{ currentStatus }} </span> <span class="opacity-60"> by {{ currentTrackArtist }} </span> </p> 
